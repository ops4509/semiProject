...
public class AdminMain_KMJ extends JFrame {
	...
	private JButton getBtnNewButton() {
		if (btnNewButton == null) {
			...
			btnNewButton.setBounds(141, 354, 119, 23);
		}
		return btnNewButton;
	}
	private JButton getBtnNewButton_1() {
		if (btnNewButton_1 == null) {
			btnNewButton_1 = new JButton("출고");
			btnNewButton_1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					ObMain obmian = new ObMain();
					obmian.setVisible(true);
				}
			});
			btnNewButton_1.setBounds(267, 354, 119, 23);
		}
	...
	private JButton getBtnNewButton_2() {
		if (btnNewButton_2 == null) {
			...
			btnNewButton_2.setBounds(21, 351, 117, 29);
		}
